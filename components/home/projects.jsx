      ...
      <div className="container mx-auto">
        ...
        <div className="project-list mt-8 grid gap-8 grid-cols-1 sm:grid-cols-2 items-center">
          <div className="project-info flex flex-col gap-8 items-center">
            <div className="project-title font-bold dark:text-gray-300 text-3xl md:text-4xl lg:text-5xl text-center sm:text-left">
          ...
          <div className="project-image shadow-xl rounded-xl transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 overflow-hidden">
            <Image
