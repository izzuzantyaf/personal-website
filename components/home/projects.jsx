  ...
  return (
    <div className="my-projects bg-gray-300 p-8">
      ...
      <div className="container mx-auto">
        <h3 className="title text-center text-4xl sm:text-5xl font-black">My works</h3>

        <div className="project-list mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 justify-center">

          <div className="project-card md:col-span-2 lg:col-start-2 lg:col-span-2 p-4 bg-white shadow-lg rounded-xl transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
