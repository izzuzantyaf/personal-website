...
const CertificateCard = (props) =>
  <div className="certificate-card p-4 bg-gray-100 dark:bg-gray-800 dark:text-gray-300 shadow-lg rounded-xl transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
