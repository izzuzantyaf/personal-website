...
export default function LearningFootprints() {
  ...
  const LearningFootprintList = () => {
    ...
    const LearningFootprintCard = (props) => {
      ...
      const ActionButton = (props) => <a href={props.data.link} target="_blank" rel="noopener noreferrer" className="action-button text-center px-8 py-2 bg-gray-200  dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-300 rounded-lg transition duration-500 ease-in-out hover:bg-gray-300">{props.data.buttonName}</a>
