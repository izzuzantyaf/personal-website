...
const SocialMediaBtn = (props) => {
  ...
  return (
    <a href={link} target="_blank" rel="noopener noreferrer" className={`p-2 rounded-md transition duration-500 ease-in-out font-semibold transform ${color} hover:-translate-y-1 hover:scale-110`}>
